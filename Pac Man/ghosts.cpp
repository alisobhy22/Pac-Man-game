...
ghosts::ghosts(int initialRow, int initialColumn, string image)
{
    ...
    //int s = score_to_exit_house;
    //inside_home = true;
    /////*  name = n;*/
    ////  ghost_box.setFillColor(g);
    ////  ghost_box.setPosition(x, y);
    /////*  ghost_color = g;*/
    //int time = Time_to_Exit_House;

};


void ghosts::moveOnWindow(int arr[23][29]) //,ta5od char)
{
